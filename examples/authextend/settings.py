# Django settings for authextend project.
...
DATABASES = {
    'default': {
        ...
        'NAME': here('auth.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'k@+j4od%k=-7vp+x47!2qhw*x9qebj#9u3(v%i*c)s9)svfp48'
